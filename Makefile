...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Wed Nov 7 21:24:40 2012
...
SOURCES       = answerframe.cpp \
		...
		questionframe.cpp \
		testframe.cpp \
		addframe.cpp moc_questionframe.cpp \
		moc_testframe.cpp \
		moc_addframe.cpp
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/clemanglaise1.0.0/ && $(COPY_FILE) --parents answerframe.h questionframe.h testframe.h addframe.h .tmp/clemanglaise1.0.0/ && $(COPY_FILE) --parents answerframe.cpp main.cpp questionframe.cpp testframe.cpp addframe.cpp .tmp/clemanglaise1.0.0/ && (cd `dirname .tmp/clemanglaise1.0.0` && $(TAR) clemanglaise1.0.0.tar clemanglaise1.0.0 && $(COMPRESS) clemanglaise1.0.0.tar) && $(MOVE) `dirname .tmp/clemanglaise1.0.0`/clemanglaise1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/clemanglaise1.0.0
...
compiler_moc_header_make_all: moc_questionframe.cpp moc_testframe.cpp moc_addframe.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_questionframe.cpp moc_testframe.cpp moc_addframe.cpp
