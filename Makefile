...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Thu Dec 20 18:01:41 2012
...
SOURCES       = answerframe.cpp \
		...
		languagebuttons.cpp \
		test.cpp \
		ampersand_escape.cpp moc_questionframe.cpp \
		moc_testframe.cpp \
		moc_addframe.cpp \
		moc_homewindow.cpp \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/clemanglaise1.0.0/ && $(COPY_FILE) --parents answerframe.h questionframe.h testframe.h addframe.h homewindow.h languagebuttons.h test.h ampersand_escape.h .tmp/clemanglaise1.0.0/ && $(COPY_FILE) --parents answerframe.cpp main.cpp questionframe.cpp testframe.cpp addframe.cpp homewindow.cpp languagebuttons.cpp test.cpp ampersand_escape.cpp .tmp/clemanglaise1.0.0/ && (cd `dirname .tmp/clemanglaise1.0.0` && $(TAR) clemanglaise1.0.0.tar clemanglaise1.0.0 && $(COMPRESS) clemanglaise1.0.0.tar) && $(MOVE) `dirname .tmp/clemanglaise1.0.0`/clemanglaise1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/clemanglaise1.0.0
