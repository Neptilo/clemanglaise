...
class Parser: public QObject {
	Q_OBJECT
    public:
        Parser(const QString& srcDst, QString file_in = "file_in", QString file_out = "file_out", QString score_file = "file_score", QObject* parent = 0);
		virtual ~Parser();
		/**
		...
		QString getCellId(const int& id, const int& nb, const QString& files);
		QString getScoreId(const int& id);
		...
		void update_score(const int& id, const int &correct);
